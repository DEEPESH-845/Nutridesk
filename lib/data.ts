    ...
    menu: [
        {
            ...
            customisation: ["Extra Cheese", "Coke", "Fries", "Onions", "Bacon"],
        },
        {
        ...
        },
        {
            ...
            customisation: ["Jalapeños", "Iced Tea", "Fries", "Salad"],
        },
        {
            ...
            protein: 29,
            category_name: "Burgers",
            customisation: ["Onions", "Fries", "Coke", "Bacon", "Avocado"],
        },
        {
            ...
            protein: 28,
            category_name: "Wraps",
            customisation: ["Extra Cheese", "Coke", "Potato Wedges", "Tomatoes"],
        },
        {
            ...
            customisation: ["Mushrooms", "Olives", "Mozzarella Sticks", "Iced Tea"],
        },
        {
        ...
        },
        {
            ...
            protein: 20,
            category_name: "Wraps",
            customisation: ["Jalapeños", "Tomatoes", "Salad", "Fries", "Iced Tea"],
        },
        {
            ...
            protein: 24,
            category_name: "Bowls",
            customisation: ["Avocado", "Sweet Corn", "Salad", "Iced Tea"],
        },
        {
        ...
        },
        {
            ...
            protein: 21,
            category_name: "Pizzas",
            customisation: ["Extra Cheese", "Olives", "Coke", "Garlic Bread"],
        },
        {
            ...
            protein: 38,
            category_name: "Bowls",
            customisation: ["Avocado", "Salad", "Sweet Corn", "Iced Tea"],
        },
        {
            name: "Paneer Burrito",
            ...
            protein: 22,
            category_name: "Burritos",
            customisation: ["Jalapeños", "Fries", "Garlic Bread", "Coke"],
        },
        {
            ...
            protein: 31,
            category_name: "Sandwiches",
            customisation: ["Bacon", "Tomatoes", "Mozzarella Sticks", "Iced Tea"],
        },
    ],
};
